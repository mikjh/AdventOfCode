...
#no intersections
@test get_intersections(parse_to_lines("U1"),parse_to_lines("R1")) == Point[]
@test get_intersections(parse_to_lines("U1,R2"),parse_to_lines("R1,U2")) == Point[Point(1,1)]

function closest_intersection(comma_sep1, comma_sep2)
    intersections = get_intersections(parse_to_lines(comma_sep1),parse_to_lines(comma_sep2))

    return minimum(map(point->abs(point.x)+abs(point.y),intersections))
end


@test closest_intersection("R8,U5,L5,D3", "U7,R6,D4,L4") == 6
@test closest_intersection("R75,D30,R83,U83,L12,D49,R71,U7,L72", "U62,R66,U55,R34,D71,R55,D58,R83") == 159
@test closest_intersection("R98,U47,R26,D63,R33,U87,L62,D20,R33,U53,R51", "U98,R91,D20,R16,D67,R40,U7,R15,U6,R7") == 135
